...
The immutability amendment, test-responsibility matrix, canonical authoring rules, evidence v2 contract, exact contextual compatibility contract, migration-manifest contract, contextual manifest-validation contract, and compatibility-preview contract are normative parts of the module-evolution decision set. They must be read together with the main decision.
