#!/usr/bin/env python3
"""Product E-05 adapter for the official direct EPUB extractor."""
            ...
            "assessments": [
                {
                    ...
                    "integrity": "valid",
                    "basis": (
                        "Raiatea produced a structurally valid normalized representation; "
                        "source completeness remains unestablished"
                    ),
                }
            ],
            "derivation_basis": (
                "Raiatea normalization over explicit ProviderEvidence references"
            ),
        },
    ...
    *,
    ...
    result["run"] = {
        ...
        "outcome": {
            ...
            "derivation_basis": (
                "E-05 Core orchestration over explicit local parser and normalization stages"
            ),
        },
        "produced": produced,
        "provenance": {
            ...
            "run_outcome_basis": (
                ...
                "and optional normalization stage"
            ),
